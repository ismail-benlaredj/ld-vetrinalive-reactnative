            ...
            <ScrollView
                ...
                <View style={styles.container}>
                    ...
                    <VStack style={styles.textCenter}>
                        <Text color="primaryText" fontSize={18}>Did you forget your password?</Text>
                        <HStack mt={4}>
                            <Text color="primaryText" fontSize={18}>Do not have an account?</Text>
                            <TouchableOpacity
                                onPress={() => {
...
export const Separator = () => {
    return (
        <HStack direction="row" space={4} width="345px" style={styles.separator}>
            ...
            <Text color="secondaryText" fontSize={14} bold>or</Text>
            <Divider
                width={148}
                _light={{
                    bg: "muted.900"
